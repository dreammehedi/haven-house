          ...
          <div key={id} className="shadow-md rounded-3xl overflow-hidden">
            ...
            <div className="p-4 flex flex-col space-y-2 pb-8">
              <div className="flex justify-between gap-4 ">
                ...
                <h4
                  data-aos="fade-right"
                  data-aos-delay={305 * id}
                  className="font-semibold text-sm font-nunito bg-green-500/50 px-3 py-2 rounded-full text-white cursor-pointer"
                >
                  Price: {price}
                </h4>
              </div>
