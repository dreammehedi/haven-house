...
function ContactInfoCart({
  ...
  return (
    <div className="border border-gray-300 p-4 md:p-6 lg:p-8 flex flex-col space-y-4 justify-center items-center text-center font-nunito rounded-3xl group transition-all duration-300 ease-linear  hover:shadow-md">
